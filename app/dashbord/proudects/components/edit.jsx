...
export default function Edit({id ,  data,  chang ,  setchang , catgory , colors , brand}){
  const img = useRef(null)
   const [error, setError] = useState([]);
    ...
    const [refrens , setrefrens] = useState({
      ...
      status : data.short_description ,
      parent_id : data.catgory_id ,
      meta_title : data.color_id ,
      meta_description : data.brand_id ,
      name : data.status ,
      description : data.meta_title ,
      status : data.meta_description ,
      parent_id : data.price ,
      meta_title : data.discount ,
      meta_description : data.quantity ,
      sort : data.sort ,
      slug : data.slug ,
    })
    ...
    async function  adddata(e){
      ...
      try {
        ...
        const response = await fetch(`http://127.0.0.1:8000/api/proudects/${data.id}`, {
          method: "POST",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                 ...
                 value={refrens.price ? refrens.price :"" }
                  type="number"
                  id="price"
                  placeholder="Enter slug"
                  className="w-full py-3 px-4 dark:text-white  dark:bg-gray-500 rounded-md bg-gray-100 focus:outline-none transition-all"
              ...
              <div>
                ...
                <input
                 ...
                 value={refrens.discount ? refrens.discount :"" }
                  type="number"
                  id="discount"
                  placeholder="Enter slug"
                  className="w-full py-3 px-4 dark:text-white  dark:bg-gray-500 rounded-md bg-gray-100 focus:outline-none transition-all"
              ...
              <div>
                ...
                <input
                 ...
                 value={refrens.quantity ? refrens.quantity :"" }
                  type="number"
                  id="quantity"
                  placeholder="Enter slug"
                  className="w-full py-3 px-4 dark:text-white  dark:bg-gray-500 rounded-md bg-gray-100 focus:outline-none transition-all"
              ...
              <div>
                ...
                <textarea 
                 ...
                 className="border rounded-md p-2 outline-none focus:outline-none shadow-md " name="description" id="description" cols="30" rows="10">{data.short_description ? data.short_description  : ""}</textarea>
              </div>
              <div>
