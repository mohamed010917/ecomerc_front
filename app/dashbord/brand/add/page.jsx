...
export default function page(){
  ...
  async function  adddata(e){
    ...
    <div className="flex justify-between items-center">
        <h1 className=" text-black dark:text-white text-2xl p-2 mb-4 font-bold">add Brand</h1>
        <Link href={"/dashbord/brand"} className="p-2 font-bold bg-blue-700 text-white rounded-md ">all Brands</Link>
    </div>
