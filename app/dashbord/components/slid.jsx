...
export default function Slid() {
    ...
    return(
        ...
        >
          <h5 className="text-base font-semibold text-gray-500  dark:text-gray-400">Dashbord</h5>
          <button
            type="button"
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li key={2} className='cursor-pointer'>
                  <Link
                    ...
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3"> <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li key={3} className='cursor-pointer'>
                  <Link
                    href="/dashbord/catgories"
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              <li key={7} className='cursor-pointer'>
                  <Link
                    href="/dashbord/proudects"
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li key={4} className='cursor-pointer'>
                  <Link
                    ...
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3 flex gap-1">
                      <span className='w-2 h-2 rounded-lg bg-red-700 '></span>
                      <span className='w-2 h-2 rounded-lg bg-blue-700'></span>
                      <span className='w-2 h-2 rounded-lg bg-green-600'></span>
                    </span>
                    <span>colors</span>
                  </Link>
              ...
              <li key={5} className='cursor-pointer'>
                  ...
                  >
                    ...
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.041 13.862A4.999 4.999 0 0 1 17 17.831V21M7 3v3.169a5 5 0 0 0 1.891 3.916M17 3v3.169a5 5 0 0 1-2.428 4.288l-5.144 3.086A5 5 0 0 0 7 17.831V21M7 5h10M7.399 8h9.252M8 16h8.652M7 19h10"/>
                    </svg>
              ...
              <li key={9} className='cursor-pointer'>
                  <Link
              ...
              <li key={10} className='cursor-pointer'>
                  <Link
                    href="/dashbord/setting"
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3 flex gap-1">
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              <li key={11} className='cursor-pointer'>
                  <Link
              ...
              <li key={12} className='cursor-pointer'>
                  <Link
                    href="/dashbord/payment"
                    className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  >
                    <span className="mr-3 flex gap-1">
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
