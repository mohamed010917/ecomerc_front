...
export default function AddItem({action , setaction,  id, chang,  SetChang, users}){
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                    <input onChange={(e) => setPram(e.target.value)} type="search" name="pram" id="pram" className="p-2 w-full rounded-md outline-none dark:bg-gray-600 focus:outline-none" placeholder="search" />
