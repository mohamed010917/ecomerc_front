...
export default function AddOrder({add ,id, setadd , chang,  setchang , users , usersearch ,  setusersearch}){
              ...
              <div className="grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  <label
                    ...
                    <select onChange={(e) => setData({...data ,user_id : e.target.value})} className="w-full p-2 bg-white dark:bg-gray-600 border rounded-md" name="user_id" id="user_id">
                      <option value="">slect pleas</option>
                        {
                            users.map(e=>{
